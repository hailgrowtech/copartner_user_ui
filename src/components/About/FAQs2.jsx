...
const FAQs2 = () => {
  ...
  return (
    <div className="flex md:flex-col w-full flex-col px-0">
      <div className="flex flex-col gap-2 xl:px-0">
        ...
        <p className="font-inter mx-auto font-[400] text-black sm:text-[18px] text-[13px] md:leading-[28px] sm:leading-[17px] leading-[16px] sm:text-start mt-2 text-center">
      ...
      {smallScreen ? (
        ...
        <div className="w-full h-[556px] grid grid-cols-2 mt-[2rem] mb-[12rem] gap-[1rem]">
          {faq_data2.map((faq) => (
            ...
            >
              <span className="text-black w-[517px] font-[500] text-[17px] leading-[20px]">
                {faq.title}
              </span>
