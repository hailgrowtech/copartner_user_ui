      ...
      <div className="flex flex-col items-center">
        <div className="flex md:flex-row items-center flex-col justify-center gap-[1rem]">
          <div className={`flex-col text-center md:gap-[2rem] gap-0`}>
            ...
            <div className={`flex flex-col gap-2 md:pb-[5rem] md:w-[1190px]`}>
              <div className="flex flex-col">
                <span
                  className="font-inter font-[700] md:text-[50px] text-[25px]
                    text-gradient-2 leading-[51px] md:w-[635px] md:h-[90px] w-[365px] h-[40px] md:text-start"
                >
                ...
                <div className="flex flex-col gap-[2rem] text-start px-[0.5rem]">
                  <span
                   ...
                   leading-[16px] md:text-start mt-2 text-center"
                  >
                  ...
                  <span className="text-dimWhite md:text-[18px] text-[11px] md:text-start text-center">
                ...
                <div className="flex flex-col py-4 gap-4">
                  ...
                  <span className="text-dimWhite md:w-full md:text-start px-[2rem]">
                  ...
                  <span className="text-dimWhite md:text-start px-[2rem] md:w-full">
                ...
                <div className="flex flex-col py-4 gap-4">
                  ...
                  <span className="text-dimWhite md:text-start px-[2.3rem] md:w-full">
                ...
                <div className="flex flex-col py-4 gap-4">
                  ...
                  <span className="text-dimWhite md:text-start px-[2.4rem] md:w-full">
                ...
                <div className="flex flex-col py-4 gap-4">
                  ...
                  <span className="text-dimWhite md:text-start px-[2.8rem] md:w-full">
                    ...
                    include inter alia (a) Data either created by You or by a
                    third party and which You wish to store on Our Platform
                    and/or servers such as image files, documents etc.; (b) Data
                    ...
                    (c) copies of government identification like driving
                    licence, election card etc. (as and when required); and (d)
              ...
              <div className="flex flex-col">
                ...
                <div className="flex flex-col gap-[2rem] text-start px-[0.5rem]">
                  ...
                  >
                    ...
                    <span className="text-lightWhite">(i)</span> to provide and
                    improve the Services and features on the Platform;{" "}
                    <span className="text-lightWhite">(ii)</span> to resolve
                    disputes and troubleshoot problems;{" "}
                    <span className="text-lightWhite">(iii)</span> to promote
                    Your safety and the safety of other individuals using the
                    Platform; <span className="text-lightWhite">(iv)</span> to
                    protect the security and integrity of the Platform and the
                    Services; <span className="text-lightWhite">(iv)</span> to
                    inform You about online and offline offers, products,
                    services, and updates;{" "}
                    <span className="text-lightWhite">(v)</span> to customise
                    Your experience on the Platform;{" "}
                    <span className="text-lightWhite">(vi)</span> to detect,
                    prevent and protect Us from any errors, fraud and other
                    criminal or prohibited activity on the Platform;{" "}
                    <span className="text-lightWhite">(vii)</span> to enforce
                    and inform about Our Terms;{" "}
                    <span className="text-lightWhite">(viii)</span> to process
                    and fulfil Your request for Services or respond to Your
                    comments, and queries on the Platform;{" "}
                    <span className="text-lightWhite">(ix)</span> to contact
                    You;
                    <span className="text-lightWhite">(x)</span> to communicate
                    ...
                    <span className="text-lightWhite"> (xi)</span> to analyse
                    usage patterns; and{" "}
                    <span className="text-lightWhite">(xii)</span> for any other
              ...
              <div className="flex flex-col">
                ...
                <div className="flex flex-col gap-[2rem] text-start px-[0.5rem]">
                  ...
                  >
                    ...
                    <span className="text-lightWhite">(i)</span> if there is an
                    unresolved issue relating to your Account, or an unresolved
                    claim or dispute;{" "}
                    <span className="text-lightWhite">(ii)</span> if We are
                    required to by applicable law; and/or in aggregated and/or
                    anonymized form; or{" "}
                    <span className="text-lightWhite">(iii)</span> Company may
            ...
            <div className={`flex flex-col gap-2 md:pb-[4rem] md:w-[1190px]`}>
              <div className="flex flex-col">
                <span
                  className="font-inter font-[700] md:text-[50px] text-[25px]
                    text-gradient-2 leading-[51px] md:w-[935px] md:h-[90px] w-[365px] h-[40px] md:text-start"
                >
            ...
            <div className={`flex flex-col gap-2 md:pb-[4rem] md:w-[1190px]`}>
              <div className="flex flex-col">
                <span
                  className="font-inter font-[700] md:text-[50px] text-[25px]
                    text-gradient-2 leading-[51px] md:w-[1035px] md:h-[100px] w-[365px] h-[40px] md:text-start"
                >
              ...
              <div className="flex flex-col">
                ...
                <div className="flex flex-col gap-[2rem] text-start px-[0.5rem]">
                  ...
                  >
                    ...
                    sent in writing to compliance@rigi.club. In case You do not
            ...
            <div className={`flex flex-col gap-2 md:pb-[4rem] md:w-[1190px]`}>
              <div className="flex flex-col">
                <span
                  className="font-inter font-[700] md:text-[50px] text-[25px]
                    text-gradient-2 leading-[51px] md:w-[735px] md:h-[60px] w-[365px] h-[40px] md:text-start"
                >
                  8. Grievance Officer
                </span>
