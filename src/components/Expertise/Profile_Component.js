  ...
  return (
    <div className='profile-div rounded-xl'>
      <div className="background-wrapper">
        ...
        <div>
          <img src={expert.image} alt={`Profile of ${expert.name}`} className="profile-image md:max-h-48 mx-auto" />
        </div>
      </div>
      <div className="info">
        ...
        <div className="description text-dimWhite md:mb-6 mb-1 md:text-[15px] text-[8px]">{expert.description}</div>
