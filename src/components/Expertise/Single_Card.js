    ...
    <div className="mx-auto">
      <div className="flex-col-3 hover:bg-[#18181B] rounded-xl md:px-8 pb-2">
        ...
        <div className="flex my-2">
          <div className="md:w-[120px] w-[100px] md:h-[26px] h-[20px] flex items-center justify-center rounded-[21.5px] border-[0.67px] border-solid border-[rgba(255,255,255,0.3)] md:me-auto mx-auto bg-gray-600">
