  ...
  return (
    <div className={`flex md:flex-col flex-col ${styles.paddingY} background-img-div`}>
      ...
      >
        ...
        <p
          className="font-poppins font-[500] text-dimWhite md:text-[15px] md:leading-[28px]
        ...
        <div className="flex pt-[2rem] grid-cols-2 md:flex">
          <div className="md:w-[256px] h-[285px] rounded-[11px] p-4 relative flex flex-col items-center hover:bg-[#18181B] hover:opacity[50%] transition duration-150 ease-in-out">
            ...
            <div className="w-[256px] p-6 flex flex-row">
              <div className="flex w-[213px] h-[26px] flex-row justify-evenly">
            ...
            <div className="w-[171px] pb-3 flex flex-row items-center justify-center">
              <div className="flex">
                <div className="flex flex-col w-[52px] h-[33px] items-center">
                  ...
                  <span className="text-white font-[600] text-[10px] leading-[12px]">
                    7+
                  </span>
                </div>
              </div>
