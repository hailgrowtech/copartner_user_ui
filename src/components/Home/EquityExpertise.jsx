...
const EquityExpertise = () => {
  return (
    <div className={`flex flex-col sm:py-[2rem] py-6`}>
      <div className="flex flex-row justify-between xl:px-0">
        <div className="flex flex-col md:h-[52px] h-[34px] justify-center md:justify-between pb-[2rem] md:items-start">
          ...
          <p className="font-poppins md:w-[737px] md:h-[28px] w-[328px] h-[34px] font-[400] text-dimWhite md:text-[18px] text-[11px] md:leading-[28px] md:leading-[17px]
      ...
      <div className="flex gap-[1rem] py-[4rem] md:py-[4rem] grid md:grid-cols-3 grid-cols-2">
