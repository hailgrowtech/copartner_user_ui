          ...
          filteredData.slice(0, 3).map((expert, id) => {
            return (
              <div className="flex flex-col hover:bg-[#18181B] hover:opacity[50%] transition duration-150 ease-in-out rounded-[11px] p-2">
                ...
                <div onClick={() => handleTelegram(expert.telegramChannel)} className="md:w-[211px] mx-auto bg-[#0081F1] md:h-[40px] w-[146px] h-[38px] flex items-center justify-center rounded-[21.5px] mt-2 md:mt-0">
