...
const LiveChatSection = () => {
  return (
    <div className='flex flex-col md:mt-[100px] mt-5 border-[1px] border-[#ffffff41] rounded-[20px] pb-3'>
      
      <div className=''>
        <Marquee gradient={false} style={{ borderTopLeftRadius: '20px', borderTopRightRadius:'20px', background: 'linear-gradient(90.81deg, #0181F1 -6.15%, #5ABEE2 54.57%, #AF53AC 107.78%)', color: 'white', padding: '2px 0' }}>
