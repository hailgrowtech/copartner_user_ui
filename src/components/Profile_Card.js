  ...
  return (
    <div className='profile-div rounded-2xl p-1 md:p-1'>
      ...
      <div className="info">
        ...
        <div className="description text-[#A1A1AACC] mb-2 text-sm md:text-base text-left">{expert.description}</div>
        <div className="prize-subscription text-white text-center gap-3">
          <button className='flex items-center bg-[#ffffff32] mx-auto my-2 py-1 px-2 md:py-2 md:px-6 border-solid border-2 border-[#4e4e4ecc] rounded-3xl'>1 month Subscription</button>
