    ...
    return (
      <div className='profile-div rounded-2xl p-1 md:p-4 mb-8'>
        ...
        <div className="info">
          ...
          <div className="description text-[#A1A1AACC] mb-2 text-sm md:text-base">{expert.description}</div>
          <div className="prize-subscription text-white">
            <button className='flex items-center mx-auto py-1.5 px-6 border-solid border-2 border-[#4e4e4ecc] rounded-3xl'><FaTelegram className='text-[#2297d0] bg-[white] rounded-[50%] text-[1.5rem] telegram me-3' />Join Telegram<IoIosArrowForward className='ms-3'/></button>
          </div>
        </div>
      </div>
    );
