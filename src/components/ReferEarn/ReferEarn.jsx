    ...
    >
      ...
      >
        <div className="flex flex-col justify-center items-center w-[328px] h-[143px]">
          ...
          <span className="text-dimWhite md:w-[555px] w-[328px] md:h-[112px] h-[85px] font-[400] font-inter text-[18px] leading-[28px] text-center">
            ...
            decision-making, and fingertips. <span className="text-lightWhite">
            Say no to spreadsheets and tools
            designed in the 80s.
            </span>
          </span>
        </div>
