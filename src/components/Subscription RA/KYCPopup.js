...
const KYCPopup = ({ onClose }) => {
  ...
  const handleSave = () => {
    if (!name || !email || !panCard || !address || !state) {
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-[#18181b] border-[1px] border-[#ffffff24] rounded shadow-md w-[90%] md:w-[400px] relative">
        ...
        <div className="grid grid-cols-2 gap-2 px-6 py-3">
          ...
          <div className="mb-4 md:col-span-1">
            <label htmlFor="panCard" className="block mb-1 text-sm text-white">PAN Card</label>
            <input
              type="text"
              id="panCard"
              value={panCard}
          ...
          <div className="flex col-span-2 items-start gap-2 py-2 md:text-[12px] text-[10px]">
